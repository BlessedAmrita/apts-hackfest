...
const EventBanner = () => {
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-r from-orange-50 to-orange-100 py-16 md:py-24">
      <div className="container relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            Event Registration & Feedback Hub
          </h1>
          <p className="text-xl text-gray-800 mb-8">
            Register for upcoming events and share your experience - helping us create better events for everyone.
          </p>
          <div className="flex items-center gap-2 text-gray-800 font-medium">
            <CalendarCheck className="h-5 w-5" />
            <span>Multiple events available this month</span>
          </div>
        </div>
      </div>
