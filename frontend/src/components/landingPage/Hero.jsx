...
const HeroSection = () => {
  ...
  const handleLogin = (role) => {
    signInWithGoogle(dispatch, router, role);
  };
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 md:gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <Button variant="outline" className="bg-orange-200  hover:bg-transparent hover:text-black text-white border-yellow-400 font-bold px-2 sm:px-6 py-6 text-lg h-auto" onClick={() => handleLogin('organiser')}>
              Get Started – Monitor Your Event Now
            </Button>
            <Button variant="outline" className="bg-orange-200 hover:bg-tranparent hover:text-black border-yellow-400 text-white font-bold  hover:bg-transparent px-2 sm:px-6  py-6 text-lg h-auto" onClick={() => handleLogin('attendee')}>
